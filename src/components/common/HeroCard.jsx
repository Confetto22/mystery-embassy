...
const HeroCard = () => {
  return (
    <section className="hero_card bg-[url('https://res.cloudinary.com/dv9aqxptd/image/upload/v1737054656/homchapel/DSC_0853_z9hg0z.webp')] bg-cover bg-center">
      <div className="cover relative bg-[#000000aa] min-h-[100vh] px-8  pb-20 md:pb-0 flex flex-col items-center md:items-start justify-center gap-5 text-white">
        ...
        <div className="herocard_buttons flex flex-col md:items-start items-center gap-5 md:flex-row z-[2]">
          <Link
            to={"#"}
        ...
        <div className="bg-[#404f40] md:rounded-tl-[4rem] absolute bottom-0 w-full py-9 md:max-w-[380px] right-0  min-h-[15vh] max-h-[25vh] flex flex-col items-center md:items-start px-12 justify-center z-[1]">
